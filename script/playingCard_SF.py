...
gbs.init("playingCard_SF.yaml") #load config as global variables
...
if __name__ == '__main__':
    try:
        ...
        raw_input()
        motion_primitives.set_pose_relative([0, 0.198, 0]) #0.25
        ...
        print "move down"
        motion_primitives.set_pose_relative([0, 0, -0.043])
        raw_input()
        ...
        center = [P_w_center[0], P_w_center[1]+0.0, P_w_center[2]-0.043] 
