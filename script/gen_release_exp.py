...
gbs.init("gen_release_exp.yaml") #load config as global variables
...
if __name__ == '__main__':
    try:
        ...
        raw_input()
        motion_primitives.set_pose_relative([0, 0.219, 0]) #0.25
        ...
        print "move down"
        motion_primitives.set_pose_relative([0, 0, -0.049])
        raw_input()
        ...
        regrasp.generalized_release(np.multiply(axis, -1),24,0.049,0.01)
        raw_input()

        center = [P_w_center[0], P_w_center[1]+0.0, P_w_center[2]-0.049] 
