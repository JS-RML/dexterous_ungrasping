...
if __name__ == '__main__':
    ...
    try:
        ...
        for i in range(3):
            for j in range(4):
                regrasp_pose=[-0.344-0.067*j, 0.538+0.097*i, 0.342+0.0015*(i/2), -0.7071, -0.0, 0.7071, 0.0]
                ...
                #rospy.spin()
        motion_primitives.set_pose_relative([0,0,0.2])
...
delta_0: 0.053 #0.0425 # distance from fingertip to object tip within gripper
theta_0: 30.0
