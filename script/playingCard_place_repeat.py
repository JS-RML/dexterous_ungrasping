...
gbs.init("playingCard_place_repeat.yaml") #load config as global variables
...
if __name__ == '__main__':
    try:
        ...
        raw_input()
        motion_primitives.set_pose_relative([0, 0.25, 0]) #0.25
        ...
        print "move down"
        motion_primitives.set_pose_relative([0, 0, -0.051]) #-0.044-0.006=-0.052
        ...
        center = [P_w_center[0], P_w_center[1]+0.0, P_w_center[2]-0.044] 
