...
if __name__ == '__main__':
    try:
        ...
        raw_input()
        motion_primitives.set_pose_relative([0, 0.184, 0]) #0.25
        ...
        print "move down"
        motion_primitives.set_pose_relative([0, 0, -0.0415])
        raw_input()
        ...
        center = [P_w_center[0], P_w_center[1]+0.0, P_w_center[2]-0.0415] 
