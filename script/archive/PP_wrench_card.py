...
from sensor_msgs.msg import JointState # TODO: import /wrench
def print_transition(transition_label):
    msg = rospy.wait_for_message('/joint_states', JointState, timeout = None) # TODO: /wrench
    print transition_label, ": ",  msg.header.stamp.secs, "secs" # TODO: msg.header.stamp.secs
...
if __name__ == '__main__':
    ...
    try:
        ...
        pre_pick_pose = [-0.078, 0.592, 0.466, 0.7071, -0.0, -0.7071, 0.0]
        ...
        regrasp_pose=[-0.344, 0.538, 0.411, -0.7071, -0.0, 0.7071, 0.0]
        '''
        print "START"
        for i in range(20):
            Robotiq.goto(robotiq_client, pos=0.04+0.001*i, speed=config['gripper_speed'], force=config['gripper_force'], block=True)
            print i
        print "STOP"
        '''        
