...
if __name__ == '__main__':
    ...
    try:
        ...
        pre_pick_pose = [0.476, 0.003, 0.416, 0.7071, -0.0, -0.7071, 0.0]
        pick_pose = [0.476, 0.003, 0.273, 0.7071, -0.0, -0.7071, 0.0]
        regrasp_pose_0=[0.45, -0.317, 0.360, -0.7071, -0.0, 0.7071, 0.0]
        regrasp_pose=[0.45, -0.317, 0.346, -0.7071, -0.0, 0.7071, 0.0]
        ...
        motion_primitives.set_pose(regrasp_pose_0)
        rospy.sleep(0.5)
        ...
        center = [P_w_center[0], P_w_center[1], P_w_center[2]-0.001]
