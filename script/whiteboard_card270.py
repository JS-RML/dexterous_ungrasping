...
gbs.init("whiteboard_card270.yaml") #load config as global variables
...
if __name__ == '__main__':
    try:
        ...
        print "move down"
        motion_primitives.set_pose_relative([0.04, 0, 0]) #bend 0.04
        raw_input()
        ...
        center = [P_w_center[0]+0.03, P_w_center[1], P_w_center[2]] 
