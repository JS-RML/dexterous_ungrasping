...
gbs.init("whiteboard_card.yaml") #load config as global variables
...
if __name__ == '__main__':
    try:
        ...
        pose = [white_board_pos-tcp2fingertip-object_length+delta_0, -0.53, 0.7, -0.7071, 0, 0, 0.7071]
        #0.603, -0.797
        ...
        print "move down"
        motion_primitives.set_pose_relative([0.033, 0, 0]) #bend 0.04
        raw_input()
        ...
        center = [P_w_center[0]+0.033, P_w_center[1], P_w_center[2]] 
