...
gbs.init("book_place_repeat.yaml") #load config as global variables
...
if __name__ == '__main__':
    try:
        ...
        pose = [0.603, -0.85, table_height_wrt_world+tcp2fingertip+object_length-delta_0, 0.7071, 0, -0.7071, 0]
        #0.603, -0.797
        ...
        raw_input()
        motion_primitives.set_pose_relative([0, 0.250, 0]) #0.186
        ...
        print "move down"
        motion_primitives.set_pose_relative([0, 0, -0.0430])
        raw_input()
        ...
        center = [P_w_center[0], P_w_center[1]+0.0, P_w_center[2]-0.0430] 
        ...
        motion_primitives.set_pose_relative([0, -0.003, 0.03])
