...
if __name__ == '__main__':
    ...
    try:
        ...
        # Regrasp
        pos = regrasp.regrasp(np.multiply(axis, -1), int(psi_regrasp), tcp_speed)
        rospy.sleep(0.5)
        print "GRIPPER POS:", pos
        # Tilt
        print "original: ", center[0], center[1], center[2]
        #center[1] = center[1] + random.uniform(-0.005, 0.005)
        #center[2] = center[2] + random.uniform(-0.005, 0.005)
...
# Object dimension
object_thickness: 0.025 #0.01 # object thickness in meters
