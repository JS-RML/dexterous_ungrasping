...
gbs.init("go_place_repeat.yaml") #load config as global variables
...
if __name__ == '__main__':
    try:
        ...
        pose = [0.598, -0.8, table_height_wrt_world+tcp2fingertip+object_length-delta_0, 0.7071, 0, -0.7071, 0]
        #0.603, -0.797
        ...
        center = [P_w_center[0], P_w_center[1]+0.0, P_w_center[2]-0.045] 
