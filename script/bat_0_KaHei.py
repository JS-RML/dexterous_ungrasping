...
if __name__ == '__main__':
    ...
    try:
        ...
        raw_input()
        print "init gripper"
        Robotiq.goto(robotiq_client, pos=object_thickness+0.00, speed=config['gripper_speed'], force=config['gripper_force'], block=False)   
        raw_input()
        print "init palm"
        ...
        motion_primitives.set_pose_relative([0, -0.004, 0])
