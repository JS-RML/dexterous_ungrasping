...
gbs.init("playingCard_place_HT.yaml") #load config as global variables
...
if __name__ == '__main__':
    try:
        ...
        raw_input()
        motion_primitives.set_pose_relative([0, 0.24, 0]) #0.25
        ...
        print "move down"
        motion_primitives.set_pose_relative([0, 0, -0.046]) #-0.044-0.006=-0.052
        # motion_primitives.set_pose_relative([0, 0, -0.005])
        raw_input()
        ...
        Robotiq.goto(robotiq_client, pos=width*1, speed=0.03, force=gbs.config['gripper_force'], block=False)   
        ...
        center = [P_w_center[0], P_w_center[1]+0.0, P_w_center[2]-0.046] 
        ...
        motion_primitives.set_pose_relative([0, 0, 0.03])
