...
gbs.init("book_place_HT.yaml") #load config as global variables
...
if __name__ == '__main__':
    try:
        ...
        Robotiq.goto(robotiq_client, pos=width*0.87, speed=0.03, force=gbs.config['gripper_force'], block=False)   
        #raw_input()
